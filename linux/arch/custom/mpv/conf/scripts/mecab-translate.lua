-- not really used but let's back it up anyway
...
local pos_color = {}
-- noun
pos_color["noun"] = "a0ffa0"
pos_color["proper"] = "a0ffa0"
pos_color["pronoun"] = "a0ffa0"
-- particles and such
pos_color["conjunctive"] = "ff9080"
pos_color["particle"] = "ff9080"
pos_color["suffix"] = "ff9080"
-- pos_color["接頭詞"] = "ff9080"
pos_color["prefix"] = "ff9080"
-- conjunction
pos_color["conjunction"] = "ffc0a0"
-- verb
pos_color["verb"] = "4040ff"
pos_color["aux-verb"] = "4040ff"
-- adjective
pos_color["i-adjective"] = "7070ff"
pos_color["na-adjective"] = "7070ff"
-- adverb
pos_color["adverb"] = "9090ff"
-- determiner
pos_color["prenoun"] = "b0b0ff"
-- interjection
pos_color["interjection"] = "a0ffff"
-- number
pos_color["numeral"] = "ffff50"
    ...
    if #(analyzed_caption)[1] >= word_idx + offset and word_idx + offset >= 1 then
        ...
        if not analyzed_caption[1][word_idx].translation then
            ...
            w.translation = utils.parse_json(utils.subprocess({args={
                ...
                "http://virtuales.lan:9874/jmdict_e"
            }}).stdout)
